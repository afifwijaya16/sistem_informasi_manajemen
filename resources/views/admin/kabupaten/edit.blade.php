<div class="modal fade" id="modal-edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('pekerjaan.perbarui') }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm @error('pekerjaan') is-invalid @enderror EditInputAgam"
                            id="EditInputpekerjaan" name="pekerjaan" placeholder="Masukan pekerjaan">
                        <!-- @error('pekerjaan')
